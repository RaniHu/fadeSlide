...
$(function () {
    var image_lis = $("#slide-image li"),                 //轮播图lis
        len = $("#slide-image li").length;                //轮播图片的长度(比索引值大1)
    ...
    circle_btn.mouseover(function () {
        ...
        image_lis.eq(index).stop().fadeIn(500).siblings().stop().fadeOut(500);    //使当前的轮播图淡入，其他同胞图片淡出
    });
    ...
    function move_l(){
        ...
        image_lis.eq(l).fadeIn(500).siblings().fadeOut(500);
    }
